...
//    val expr2 = "((1+0.5^2)/0.1)*2.0"
  ...
  test("calculating few expressions") {
    List[(String, CalcResult)](
      ("(1+0.5^2)/0.0*2.0", DivisionByZeroError),
      ...
      ("8*(-0.5^2)-1.234", Success(0.766)),
      ("43.567/(12.89+3.14)", Success(2.717842)),
      ("(7.345+9.654)/(0.123-0.045)", Success(217.935897)),
      ("-5.123*(-2^3)+3.789", Success(44.773)),
      ...
      ("-7.531*(-8^2+1)+9.012", Success(-480.503)),
      ...
      ("-9.765*(-4^3)+2.109", Success(627.069)),
      ...
      ("-8.456*(-2^2+2)+6.234", Success(-44.502)),
      ...
      ("-7.123*(-3^3)+4.356", Success(196.677)),
...
object CalculatorSuite {
  ...
  def assertEqualsCalcResult(
    ...
    case (DivisionByZeroError, DivisionByZeroError)   => ()
